...
# Enter in the mysql root user's password on lines 33-35 right before the /g'.
...
sed -i 's/mysqli.default_pw =/mysqli.default_pw = PASSWORD_HERE/g' /etc/php/7.4/fpm/php.ini
sed -i 's/mysqli.default_pw =/mysqli.default_pw = PASSWORD_HERE/g' /etc/php/7.4/cli/php.ini
sed -i 's/mysqli.default_pw =/mysqli.default_pw = PASSWORD_HERE/g' /etc/php/7.4/apache2/php.ini
